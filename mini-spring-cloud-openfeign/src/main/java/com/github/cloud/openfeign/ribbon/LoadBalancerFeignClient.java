...
public class LoadBalancerFeignClient implements Client {
    ...
    public LoadBalancerFeignClient(LoadBalancerClient loadBalancerClient , Client client){
    ...
    private static class RibbonRequest extends ClientRequest{
        ...
        private Request toRequest(){
            return Request.create(request.httpMethod(),getUri().toASCIIString(),new HashMap<>(),request.body(), StandardCharsets.UTF_8);
        }
    }
